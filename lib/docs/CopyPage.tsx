 ...
 *
 * The "Open with" menu that sat beside it — Claude, ChatGPT, raw markdown — is
 * commented out for want of room in the header; see the TODO below.
 */
...
//   }
  ...
  // TODO: restore the "Open with" menu. It is commented out below rather than
  // deleted — the markdown route, the prompt and the three entries all still
  // work; the header simply has no room for a labelled control beside the
  // title, the copy button and the two pager arrows, and at narrow widths it
  // was the thing that pushed the row into wrapping. Move it somewhere with
  // more space (the right-hand panel, or the page footer beside the pager) and
  // uncomment.
//
//       <Menu.Root>
