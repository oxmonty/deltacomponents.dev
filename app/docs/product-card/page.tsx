...
const ESSAYS = [
  { title: "Buy Wisely", author: "Paul Graham", image: "/images/essays/buy-wisely.jpg" },
  { title: "On Becoming Competitive", author: "Ludwig", image: "/images/essays/on-becoming-competitive.jpg" },
  { title: "Salary Negotiations", author: "Patrick McKenzie", image: "/images/essays/salary-negotiations.jpg" },
  { title: "Solution Space & Taste", author: "Grant Slatton", image: "/images/essays/solution-space-taste.jpg" },
  { title: "The Bear Manifesto", author: "Herman", image: "/images/essays/the-bear-manifesto.jpg" },
  { title: "Write Like You Talk", author: "Paul Graham", image: "/images/essays/write-like-you-talk.jpg" },
];
...
<div className="grid grid-cols-2 gap-6 sm:grid-cols-3">
  {essays.map((essay) => (
    <a key={essay.title} href={essay.url} target="_blank" rel="noreferrer">
...
function Grid() {
  return (
    <div className="grid w-full grid-cols-2 gap-5 sm:grid-cols-3">
      {ESSAYS.map((essay) => (
        <ProductCard key={essay.title} className="w-full max-w-none rounded-none">
          <ProductCardImage src={essay.image} alt={essay.title} className="rounded-none" />
          <ProductCardContent>
            <ProductCardHeader>
              <ProductCardTitle>{essay.title}</ProductCardTitle>
